...
#[derive(Debug)]
pub struct NexusMLProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NexusMLProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NexusML processing");
    
    let mut processor = NexusMLProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NexusMLProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NexusMLProcessor::new(false);
